% 10 min interval
data_20160112 = csvread('../data/cico/export/20160112_rta_rtd.csv');
...
data_20160209 = csvread('../data/cico/export/20160209_rta_rtd.csv');
...
data_20160315 = csvread('../data/cico/export/20160315_rta_rtd.csv');
...
figure;
hold on
plot(data_20160112(84:108,1), data_20160112(84:108,2), 'Color', 'red');
xlabel('t');
ylabel('arrivals/t');
figure;
plot(data_20160209(84:108,1), data_20160209(84:108,2), 'Color', 'red');
xlabel('t');
ylabel('arrivals/t');
figure;
plot(data_20160315(84:108,1), data_20160315(84:108,2), 'Color', 'magenta');
xlabel('t');
ylabel('arrivals/t');
hold off
%hold on;
